...
const categories: ServiceCategory[] = [
  {
    ...
    desc: "We help organisations design, implement and maintain quality systems, compliance frameworks and certification readiness programmes — from documentation and internal auditing through to digital QMS adoption. Every engagement is practical, context-specific and focused on lasting results.",
      ...
      <section id="qms-platform" className="container-page py-16">
        <div className="rounded-2xl overflow-hidden border border-border shadow-[var(--shadow-card)]">
          ...
          <div className="bg-navy p-8 md:p-12 relative overflow-hidden">
            ...
            <div className="absolute -left-10 bottom-0 size-48 rounded-full blur-3xl" style={{ background: "var(--color-teal)", opacity: 0.1 }} />
            <div className="relative flex flex-col md:flex-row gap-6 items-start md:items-center">
              ...
              <div className="flex-1">
                ...
                <p className="mt-2 text-white/70 leading-relaxed max-w-2xl">
                  A cloud-based digital quality management system that replaces paper-based processes with structured, traceable and accessible digital workflows — covering documentation, audits, corrective actions, approvals, compliance monitoring and training records.
                </p>
              </div>
          ...
          <div className="p-8 md:p-12 grid md:grid-cols-2 gap-10 bg-card">
            <div>
              <h3 className="font-display font-bold text-navy mb-4">How it's implemented</h3>
              <ol className="space-y-3">
                {[
                  "Discovery and scoping — understanding your processes, team structure and compliance requirements",
                  "Platform configuration — modules, document libraries, audit templates and workflows",
                  "Data migration — transferring existing policies, procedures and records",
                  ...
                  <li key={i} className="flex gap-3 text-sm">
                    <span className="size-6 rounded-full grid place-items-center text-xs font-bold shrink-0 mt-0.5 text-white" style={{ background: "var(--color-orange)" }}>
                      {i + 1}
                    </span>
      ...
      <div className="relative overflow-hidden" style={{ background: `color-mix(in srgb, ${cat.accent} 6%, var(--color-card, #fff))` }}>
        ...
        <div className="container-page py-10 md:py-14 relative">
          <div className="flex flex-col md:flex-row gap-6 items-start">
            ...
            <div className="flex-1">
              <div
                className="inline-flex items-center gap-1.5 text-xs font-bold tracking-wider uppercase px-3 py-1 rounded-full mb-3"
                style={{ background: `color-mix(in srgb, ${cat.accent} 12%, transparent)`, color: cat.accent }}
              >
            ...
            <div className="shrink-0 text-right hidden md:block">
              <div className="text-5xl font-display font-black" style={{ color: `color-mix(in srgb, ${cat.accent} 20%, transparent)` }}>
                {cat.services.length}
              </div>
        ...
        <div className="flex-1">
          ...
          <div className="p-6 md:p-8 grid lg:grid-cols-12 gap-6">
            ...
            <div className="flex lg:flex-col items-center lg:items-start gap-3 lg:col-span-1">
              ...
              <div className="text-xs font-bold tracking-wider" style={{ color: accent }}>
            ...
            <div className="lg:col-span-4 space-y-4">
              ...
              <div className="flex flex-wrap gap-2 pt-1">
                {s.cta?.kind === "external" ? (
                  <a href={s.cta.href} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-md text-white px-4 py-2.5 text-sm font-semibold hover:opacity-90" style={{ background: "var(--color-orange)" }}>
                    {s.cta.label} <ArrowRight className="size-4" />
                  </a>
                ) : s.cta?.kind === "internal" ? (
                  <Link to={s.cta.href} className="inline-flex items-center gap-2 rounded-md text-white px-4 py-2.5 text-sm font-semibold hover:opacity-90" style={{ background: "var(--color-orange)" }}>
                    {s.cta.label} <ArrowRight className="size-4" />
                  </Link>
                ) : (
                  ...
                  <ol className="space-y-3">
                    {s.how.map((step, idx) => (
                      <li key={idx} className="flex gap-3 text-sm">
                        <span className="size-6 rounded-full grid place-items-center text-xs font-bold shrink-0 mt-0.5" style={{ background: `color-mix(in srgb, ${accent} 15%, transparent)`, color: accent }}>
                          {idx + 1}
                        </span>
                        <span className="text-muted-foreground leading-relaxed">{step}</span>
                      </li>
                ...
                <div>
                  ...
                  <div className="mt-6 rounded-xl p-4 border" style={{ background: `color-mix(in srgb, ${accent} 5%, transparent)`, borderColor: `color-mix(in srgb, ${accent} 20%, transparent)` }}>
                    <p className="text-xs text-muted-foreground leading-relaxed">
                      Not sure if this applies to your situation? <Link to="/contact" className="font-semibold hover:underline" style={{ color: accent }}>Contact our team</Link> — we'll advise honestly on the best approach.
                    </p>
                  </div>
                </div>
              </div>
